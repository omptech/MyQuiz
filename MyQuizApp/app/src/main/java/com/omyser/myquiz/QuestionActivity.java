...
import static com.omyser.myquiz.SetsActivity.setsIDs;
import static com.omyser.myquiz.SplashActivity.catList;
import static com.omyser.myquiz.SplashActivity.selected_cat_index;
                ...
                .setListener(new Animator.AnimatorListener() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                            if(value == 0)
                            {
                                ...
                                if(viewNum != 0)
                                    ((Button)view).setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#3EB0F7")));
